...
import { X, Wifi, Monitor, HardDrive, Cpu, Network, User, MapPin } from "lucide-react"
...
interface Z8StationModalProps {
  station: Z8Station | null
  isOpen: boolean
  onClose: () => void
}

export function Z8StationModal({ station, isOpen, onClose }: Z8StationModalProps) {
              ...
              <div className="bg-gradient-to-r from-purple-50 to-indigo-50 p-4 rounded-lg border border-purple-200">
                ...
                <div className="space-y-2">
                  ...
                  <div>
                    ...
                    <p className="text-base font-semibold">{station.pcName}</p>
                  </div>
                  <div>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-cyan-50 p-4 rounded-lg border border-blue-200">
                ...
                <div className="space-y-2">
                  <div>
                    ...
                    <p className="font-mono text-sm bg-white p-2 rounded border">{station.ipAddress}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="font-mono text-xs bg-white p-2 rounded border">{station.macAddress}</p>
                  </div>
                  <div>
          ...
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-4 rounded-lg border border-green-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="bg-white p-3 rounded border">
                ...
                <p className="text-sm font-semibold">{station.pcSpecs.processor}</p>
              </div>
              <div className="bg-white p-3 rounded border">
                <div className="flex items-center gap-2 mb-1">
                ...
                <p className="text-sm font-semibold">{station.pcSpecs.ram}</p>
              </div>
              <div className="bg-white p-3 rounded border">
                <div className="flex items-center gap-2 mb-1">
                ...
                <p className="text-sm font-semibold">{station.pcSpecs.storage}</p>
              </div>
              <div className="bg-white p-3 rounded border">
                <label className="text-sm font-medium text-gray-600">Sistema Operativo</label>
                <p className="text-sm font-semibold">{station.pcSpecs.os}</p>
              </div>
              {station.pcSpecs.graphics && (
                <div className="bg-white p-3 rounded border">
                  <label className="text-sm font-medium text-gray-600">Tarjeta Gráfica</label>
                  <p className="text-sm font-semibold">{station.pcSpecs.graphics}</p>
                </div>
              )}
            </div>
          </div>
